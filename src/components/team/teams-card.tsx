...
/**
 * Renders a settings card that lists teams for the current organization and provides a control to open a create-team dialog.
 *
 * @returns The rendered Teams settings card and its associated CreateTeamDialog element
 */
