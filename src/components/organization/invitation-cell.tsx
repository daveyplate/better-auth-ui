...
/**
 * Renders a card representing a pending organization invitation with its email, expiration date, role, and a menu action to cancel the invitation.
 *
 * @param props.className - Optional additional container class name
 * @param props.classNames - Optional object of className overrides for internal parts (cell, button, icon, outlineButton)
 * @param props.invitation - The invitation to display
 * @param props.localization - Optional localization overrides merged with context localization
 * @param props.organization - The organization the invitation belongs to
 * @returns The rendered invitation card element
 */
