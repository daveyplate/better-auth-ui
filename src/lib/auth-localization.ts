export const authLocalization = {
  ...
  twoFactorEnableInstructions:
    "Please prepare your authenticator app to scan the QR code",

  /** @default "You will need to enter your password to disable 2FA" */
  twoFactorDisableInstructions:
    "You will need to enter your password to disable 2FA",
  ...
  enhancedSecurityDescription:
    "2FA adds an additional layer of protection to your account",
