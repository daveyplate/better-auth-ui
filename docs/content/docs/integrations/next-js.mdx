...
Create a dynamic route segment for authentication views in `app/auth/[page]/page.tsx`.

```tsx title="app/auth/[page]/page.tsx"
...
```tsx title="app/account/[page]/page.tsx"
...
```tsx title="app/organization/[page]/page.tsx"
import { OrganizationView } from "@daveyplate/better-auth-ui"
import { organizationViewPaths } from "@daveyplate/better-auth-ui"
...
```tsx title="app/organization/[slug]/[page]/page.tsx"
import { OrganizationView } from "@daveyplate/better-auth-ui"
import { organizationViewPaths } from "@daveyplate/better-auth-ui"
